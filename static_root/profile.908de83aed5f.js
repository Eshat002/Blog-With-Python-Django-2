    ...
    $.ajax({
        ...
        success: function (response) {
         ...
         <div class="social-container">
                    ...
                    <a href="${response.data1.twitter_url}" class="twitter-url">
                    ...
                    <a style="padding-right:7px;padding-bottom:3px" href="${response.data1.insta_url}" class="insta-url">
            ...
            for (const post of response.data2) {
                profile_sec_section_row.innerHTML += `
                 <div style="cursor:pointer" onclick="window.location.href='/posts/${post.slug}/'"  class='col-lg-4 col-md-6 col-sm-6 mb-5'>
