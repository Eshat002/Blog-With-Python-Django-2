...
function get_post_detail_data() {
    $.ajax({
        ...
        success: function (response) {
            ...
            <p class="re-post-category "><span class='re-post-category-span' >${response.data1.category}</span></p>
            <h2 class='re-post-title'>${response.data1.title}</h2>
                ...
                <div class="re-post-details d-flex">
                                ...
                                <div class="d-flex px-2 re-post-time-container">
                                    ...
                                    </svg><span class="re-post-details-text"> ${response.data1.readtime} Read </span>
                                </div>

                            </div>
                            <img  class='twitter-featured-image  mt-4 mb-2' alt='featured-image' src="${response.data1.featured_image_url}">
